...
# herdr (dir also holds runtime logs/sockets/session.json, so only link config.toml/agent-detection/scripts)
...
ln -snfv "${SCRIPT_DIR}/herdr/scripts" "${DOTCONF_DIR}/herdr"
